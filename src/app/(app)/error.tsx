...
export default function AppError({
  ...
  return (
    <div className="flex-1 flex items-center justify-center px-4 py-16 gradient-mesh relative overflow-hidden">
      ...
      <div className="glass-card p-8 sm:p-10 max-w-md w-full text-center page-transition relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <a
            href="/"
            className="text-muted-foreground hover:text-foreground transition-colors text-sm inline-flex items-center gap-2 px-5 py-2 rounded-md no-underline"
          >
            На главную
          </a>
        </div>
