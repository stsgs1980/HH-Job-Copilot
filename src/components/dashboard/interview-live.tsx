      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="glass-card rounded-2xl rounded-tl-sm p-4 space-y-3">
          ...
          <div className="rounded-xl gradient-border bg-gradient-to-br from-cyan/5 to-purple/5 overflow-hidden">
            ...
            <div className="p-3 space-y-2">
              ...
              <p className="text-sm">
                <span className="font-semibold text-purple">Интервьюер:</span>{' '}
              ...
              <div className="bg-emerald-500/5 border border-emerald-500/15 rounded-lg p-2.5 gradient-border">
                <div className="flex items-center justify-between gap-2">
                  ...
                  {ttsEnabled && displayHint && !isHintLoading && (
                    ...
                    >
                      {isSpeaking ? (
                        <VolumeX className="w-3 h-3 text-purple" />
                      ) : (
                        <Volume2 className="w-3 h-3 text-purple/60 hover:text-purple" />
                      )}
                    </Button>
                  )}
                </div>
                ...
                {asrEnabled && isRecording && (
                  <span className="flex items-end gap-0.5 h-4">
                    {[0, 0.15, 0.3, 0.45, 0.6].map((d, i) => (
                      <span
                        key={i}
                        className="w-0.5 bg-purple rounded-full animate-wave"
        ...
        <div className="flex items-center gap-2 mt-1.5">
          ...
          {asrEnabled ? (
            ...
            <Badge variant="secondary" className="text-[10px] h-4 gap-1 bg-purple/10 text-purple border-0">
            ...
            <Button
              ...
              className={`h-6 w-6 rounded-full ${
                isRecording
                  ...
                  : 'bg-purple/10 text-purple hover:bg-purple/20 hover:text-purple'
              }`}
