        ...
        <div className="glass-card rounded-2xl rounded-tl-sm p-4 space-y-3">
          ...
          <div className="rounded-xl gradient-border bg-gradient-to-br from-cyan/5 to-purple/5 overflow-hidden">
            <div className="flex items-center gap-2 px-3 py-2 border-b border-cyan/10">
              <span className="flex items-center gap-1.5 text-xs font-semibold text-red-400 streak-glow rounded px-1.5 py-0.5"><span className="w-2 h-2 rounded-full bg-red-400 animate-pulse-dot" /> LIVE</span>
              ...
              <p className="text-sm flex items-center gap-2">
                ...
                <span className="flex items-end gap-0.5 h-4">
                  {[0, 0.15, 0.3, 0.45, 0.6].map((d, i) => (
                    <span key={i} className="w-0.5 bg-purple rounded-full animate-wave" style={{ animationDelay: `${d}s`, height: `${0.5 + i * 0.2}rem` }} />
                  ))}
                </span>
              </p>
            </div>
